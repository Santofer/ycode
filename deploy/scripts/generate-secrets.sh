...
echo "  - SITE_URL (your ycode domain, e.g., https://ycode.n0.ma)"
echo "  - API_EXTERNAL_URL (your Supabase API domain, e.g., https://supa.n0.ma)"
echo "  - SUPABASE_PUBLIC_URL (same as API_EXTERNAL_URL)"
echo "  - SELF_HOSTED_SUPABASE_HOSTNAME (e.g., supa.n0.ma)"
