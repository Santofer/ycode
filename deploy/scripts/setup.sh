...
echo ""
echo "  1. SITE_URL             — Your ycode domain (e.g., https://ycode.n0.ma)"
echo "  2. API_EXTERNAL_URL     — Supabase API URL (e.g., https://supa.n0.ma)"
echo "  3. SUPABASE_PUBLIC_URL  — Same as API_EXTERNAL_URL"
echo "  4. SELF_HOSTED_SUPABASE_HOSTNAME — e.g., supa.n0.ma"
...
echo "     → ${SITE_URL:-https://ycode.n0.ma}/ycode/welcome"
echo ""
